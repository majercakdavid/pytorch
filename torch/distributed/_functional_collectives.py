...
def all_to_all_single(
    ...
    that information and perform collective algebraic optimization. Use other forms of input for that.
    """
    int_dtypes = set([torch.uint8, torch.int8, torch.int16, torch.int32, torch.int64])
...
def _register_ops():
    ops_defs = [
        ...
        "all_to_all_single(Tensor input, Tensor? output_split_sizes, Tensor? input_split_sizes, str tag, int[] ranks, int group_size) -> Tensor",
    ]
